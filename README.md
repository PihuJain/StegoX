...
StegoX was built during PydroidX, a hackathon organized by the Android Club at VIT Bhopal University, and won the Best Collaboration Award. It hides messages in images, audio and video using LSB steganography, AES-256 encryption and Whisper AI voice authentication, with a Streamlit web app and an Android client.

## Live Demo

[stegox.vercel.app](https://stegox.vercel.app) (not deployed yet)

## Hackathon

- **Event**: PydroidX, organized by the Android Club at VIT Bhopal University
- **Award**: Best Collaboration Award
- **Story**: Two separate teams merged on the spot at the venue and built StegoX together under hackathon time pressure. Full writeup on [LinkedIn](https://www.linkedin.com/posts/activity-7466520739895246848-dyu5).
